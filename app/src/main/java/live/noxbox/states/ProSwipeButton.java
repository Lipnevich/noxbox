...
public class ProSwipeButton extends RelativeLayout {
    ...
    @Nullable
    private in.shadowfax.proswipebutton.ProSwipeButton.OnSwipeListener swipeListener = null;
    private float swipeDistance = DEFAULT_SWIPE_DISTANCE;

    public ProSwipeButton(Context context, int textColorInt, int bgColorInt, CharSequence btnText) {
        super(context);
        this.context = context;
        this.textColorInt = textColorInt;
        this.bgColorInt = bgColorInt;
        this.btnText = btnText;
        this.arrowColorInt = getResources().getColor(R.color.secondaryTr);
        init();
    }
    ...
    public void setOnSwipeListener(@Nullable in.shadowfax.proswipebutton.ProSwipeButton.OnSwipeListener customSwipeListener) {
