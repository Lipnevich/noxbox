...
public enum NoxboxType {
    ...
    cleaning(7, R.string.cleaning, R.string.cleaner, R.drawable.ic_cleaning_demand, R.drawable.ic_cleaning_demand, R.drawable.illustration_cleaning, R.string.cleaningDescription, R.string.cleaningDuration, "60"),
