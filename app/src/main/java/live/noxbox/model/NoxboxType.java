...
public enum NoxboxType {
    ...
    hairdresser(5, R.string.haircut, R.string.hairdresser, R.drawable.ic_hairdresser, R.drawable.illustration_hairdresser, R.string.haircutDescription, R.string.haircutDuration, "60"),
