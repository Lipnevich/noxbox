...
public class ProfileActivity extends BaseActivity {
    ...
    private void drawEditPhoto(final Profile profile) {
        ...
        createCircleProfilePhotoFromUrl(getApplicationContext(), profile.getPhoto(), profilePhoto);
    ...
    public void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
        ...
        AppCache.readProfile(profile -> {
            if (requestCode == SELECT_IMAGE
                ...
                createCircleProfilePhotoFromUrl(getApplicationContext(), data.getData().toString(), profilePhoto);
                ...
                createCircleImageFromBitmap(getApplicationContext(), photoBitmap, profilePhoto);
